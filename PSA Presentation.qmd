...
::: justify
Determine the Colombian towns with potential to implement a PES scheme in biodiversity conservation modality. The town potential was established through the opportunity cost[^1] of the main farming activities in regions where the tropical dry forest is present.
:::
...
data %>% 
  ...
  e_legend(left = 'left', orient = 'vertical', itemGap = 30, height = 800, top = '10%') %>%
  e_title(text = 'Tropical dry forest distribution by Colombian regions')
```
</div>
